object frmView2: TfrmView2
  ...
  PixelsPerInch = 96
  TextHeight = 13
  object PasLibVlcPlayerView2: TPasLibVlcPlayer
    Left = 0
    Top = 0
    Width = 436
    Height = 186
    ...
    AudioOutput = aoDummy
    SnapShotFmt = 'png'
    OnMediaPlayerTimeChanged = PasLibVlcPlayerView2MediaPlayerTimeChanged
    OnMediaPlayerLengthChanged = PasLibVlcPlayerView2MediaPlayerLengthChanged
    MouseEventsHandler = mehComponent
  end
  object tbView2: TAdvTrackBar
    Left = 0
    Top = 186
    Width = 436
    Height = 33
    ...
    Version = '1.6.3.5'
    OnChange = tbView2Change
  end
  object tbOffsetView2: TAdvTrackBar
    Left = 0
    Top = 219
    Width = 436
    Height = 25
